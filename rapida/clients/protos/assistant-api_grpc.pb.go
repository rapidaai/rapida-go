...
const (
	...
	AssistantService_GetAllAssistantProviderModel_FullMethodName = "/assistant_api.AssistantService/GetAllAssistantProviderModel"
	AssistantService_CreateAssistantProviderModel_FullMethodName = "/assistant_api.AssistantService/CreateAssistantProviderModel"
...
type AssistantServiceClient interface {
	...
	GetAllAssistantProviderModel(ctx context.Context, in *GetAllAssistantProviderModelRequest, opts ...grpc.CallOption) (*GetAllAssistantProviderModelResponse, error)
	CreateAssistantProviderModel(ctx context.Context, in *CreateAssistantProviderModelRequest, opts ...grpc.CallOption) (*GetAssistantProviderModelResponse, error)
...
func (c *assistantServiceClient) GetAllAssistantProviderModel(ctx context.Context, in *GetAllAssistantProviderModelRequest, opts ...grpc.CallOption) (*GetAllAssistantProviderModelResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetAllAssistantProviderModelResponse)
	err := c.cc.Invoke(ctx, AssistantService_GetAllAssistantProviderModel_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *assistantServiceClient) CreateAssistantProviderModel(ctx context.Context, in *CreateAssistantProviderModelRequest, opts ...grpc.CallOption) (*GetAssistantProviderModelResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetAssistantProviderModelResponse)
	err := c.cc.Invoke(ctx, AssistantService_CreateAssistantProviderModel_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AssistantServiceServer interface {
	...
	GetAllAssistantProviderModel(context.Context, *GetAllAssistantProviderModelRequest) (*GetAllAssistantProviderModelResponse, error)
	CreateAssistantProviderModel(context.Context, *CreateAssistantProviderModelRequest) (*GetAssistantProviderModelResponse, error)
...
func (UnimplementedAssistantServiceServer) GetAllAssistantProviderModel(context.Context, *GetAllAssistantProviderModelRequest) (*GetAllAssistantProviderModelResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAllAssistantProviderModel not implemented")
}
func (UnimplementedAssistantServiceServer) CreateAssistantProviderModel(context.Context, *CreateAssistantProviderModelRequest) (*GetAssistantProviderModelResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateAssistantProviderModel not implemented")
}
...
func _AssistantService_GetAllAssistantProviderModel_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetAllAssistantProviderModelRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AssistantServiceServer).GetAllAssistantProviderModel(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AssistantService_GetAllAssistantProviderModel_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AssistantServiceServer).GetAllAssistantProviderModel(ctx, req.(*GetAllAssistantProviderModelRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _AssistantService_CreateAssistantProviderModel_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateAssistantProviderModelRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AssistantServiceServer).CreateAssistantProviderModel(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AssistantService_CreateAssistantProviderModel_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AssistantServiceServer).CreateAssistantProviderModel(ctx, req.(*CreateAssistantProviderModelRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AssistantService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _AssistantService_GetAllAssistantProviderModel_Handler,
		},
		{
			MethodName: "CreateAssistantProviderModel",
			Handler:    _AssistantService_CreateAssistantProviderModel_Handler,
		},
		{
